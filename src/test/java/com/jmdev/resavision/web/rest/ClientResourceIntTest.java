...
import com.jmdev.resavision.repository.ClientRepository;
import com.jmdev.resavision.service.ClientService;
import com.jmdev.resavision.repository.search.ClientSearchRepository;
...
public class ClientResourceIntTest {
    ...
    public void createClient() throws Exception {
        ...
        assertThat(testClient.isCheckTel()).isEqualTo(DEFAULT_CHECK_TEL);
        assertThat(testClient.isChekMail()).isEqualTo(DEFAULT_CHEK_MAIL);
    ...
    public void updateClient() throws Exception {
        ...
        assertThat(testClient.isCheckTel()).isEqualTo(UPDATED_CHECK_TEL);
        assertThat(testClient.isChekMail()).isEqualTo(UPDATED_CHEK_MAIL);
